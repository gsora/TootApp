 ...
 */
public class CoolDivider extends RecyclerView.ItemDecoration {
    ...
    public CoolDivider(Context context, int orientation) {
    ...
    public CoolDivider(Context context, int orientation, int padding, int avoidResourceId) {
        final TypedArray a = context.obtainStyledAttributes(ATTRS);
        mDivider = a.getDrawable(0);
        a.recycle();
        setOrientation(orientation);
